...
<section>
    ...
    <div class="welcome--container">
        <div class="welcome--info">
            <div class="welcome--info__container">
                ...
                <img class="info--title__img" src="../../resources/static/icons/logo-sigma-blanco.png" alt="">
            </div>
            ...
            <div class="welcome--info__button">
               <a href="#section--title" class="welcome--info__link">
                    <img class="info--button__icon" src="../../resources/static/icons/continuar.png" alt="">
                    Ver más
               </a>
            </div>
        </div>
        <div class="welcome--img">
            <img class="welcome--img__svg" src="../../resources/static/svgs/undraw_Browser_stats_re_j7wy.svg" alt="">
        </div>
    </div>
    ...
    <div class="card--options__container">
        <a class="card--options__link" href="">
            <div class="card col-mb-3 col-bg-3">
                ...
                <div class="options--img__container">
                    <img class="card--options__img" src="../../resources/static/svgs/undraw_All_the_data_re_hh4w.svg" alt="">
                </div>
                <div class="card-body">
        ...
        <a class="card--options__link" href="">
            <div class="card col-mb-3 col-bg-3">
                ...
                <div class="options--img__container">
                    <img class="card--options__img" src="../../resources/static/svgs/undraw_Booked_re_vtod.svg" alt="">
                </div>
                <div class="card-body">
        ...
        <a class="card--options__link" href="">
            <div class="card col-mb-3 col-bg-3">
                ...
                <div class="options--img__container">
                    <img class="card--options__img" src="../../resources/static/svgs/undraw_deliveries_131a.svg" alt="">
                </div>
                <div class="card-body">
    ...
    <div class="announcement--container">
        ...
        <img class="announcement--container__img  img-fluid" src="../../resources/static/svgs/undraw_happy_announcement_ac67.svg" alt="">
    </div>

    <div class="contact--container">
        <div class="contact--container__img">
            <img class="contact--img" src="../../resources/static/img/person.jpg" alt="">
        </div>
