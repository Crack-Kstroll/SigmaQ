					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4 col-xl-6"> <!-- Seccion botones titulo tabla -->
							<div class="row">
								...
								<div class="col-sm-12 col-md-12 col-lg-6">				
									<a href="#modalIngresarIndiceEntrega" class="btn btn-success espacioBotones" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar indice de entrega</span></a>					
								</div>
							</div>					
