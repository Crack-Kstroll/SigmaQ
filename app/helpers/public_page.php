            ...
            <body>
                <nav class="navbar navbar-expand-lg navbar-dark bg-primary" id="navbar--header">
                    ...
                    <div class="usuario--contenedor">
                        ...
                        <div class="usuario--opciones">
                            <a href="login_clientes.php" class="usuario--contenedor__enlace">Cerrar Sesión</a>
                        </div>
                    </div>
                </nav>
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top" id="navbar--options">
                    ...
                    <div class="collapse navbar-collapse" id="navbarColor02">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="estado_cuenta.php">Estados de cuenta</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="status_pedidos.php">Status de pedidos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="indice_entrega.php">Índice de entrega</a>
                        </li>
                    </div>
                </nav>
        ');
